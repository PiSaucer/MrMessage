...
<input type="text" name="user" class="username" placeholder="User Name" required title="this is how you login">
<br>
<br>
<label for="psw"><b>Password</b></label>
<input type="password" name="pass" class="psw"placeholder="Password" required title="Keep your password safe">
